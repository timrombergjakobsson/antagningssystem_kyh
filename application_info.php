<?php
    ...
    function chosen_education_exp () {
        ...
        if ($_POST['education_2'] != "Ingen") {
            ...
            $chosen_educations['education_2'] = array ('priority' => 2, 'education' => $_POST['education_2']);
        
        }
        
        if ($_POST['education_3'] != "Ingen") {
        
            $chosen_educations['education_3'] = array ('priority' => 3, 'education' => $_POST['education_3']);
